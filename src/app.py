...
activities = {
    ...
    "Basketball Team": {
        ...
        "max_participants": 15,
        "participants": ["jacob@mergington.edu", "maria@mergington.edu"]
    },
    "Swimming Club": {
        "description": "Swim training, relays, and water safety exercises",
    ...
    "Drama Society": {
        "description": "Rehearse plays, learn stagecraft, and perform dramatic works",
        "schedule": "Thursdays, 4:00 PM - 6:00 PM",
        "max_participants": 20,
        "participants": ["isabella@mergington.edu", "oliver@mergington.edu"]
    },
    "Debate Team": {
        "description": "Practice argumentation and prepare for debate competitions",
        "schedule": "Wednesdays, 5:00 PM - 6:30 PM",
        "max_participants": 14,
        "participants": ["mason@mergington.edu", "ava@mergington.edu"]
    },
    "Science Olympiad": {
        "description": "Compete in science and engineering challenges with hands-on projects",
